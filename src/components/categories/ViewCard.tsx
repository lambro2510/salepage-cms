...
import { ProductCategoryResponse, ProductTypeResponse } from "../../interfaces/interface";
    ...
    return(
        <BasePageContainer breadcrumb={breadcrumb}>
            <ProTable
                ...
                toolBarRender={() => [
                    <Button icon={<BiPlus/>} type="primary" onClick={() => navigate(`${webRoutes.categories}/create`)}>
                        Tạo mới
                    </Button>
                ]}
            />
