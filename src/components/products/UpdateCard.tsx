...
import { ProForm, ProFormText, ProFormSelect, ProFormList, ProCard } from '@ant-design/pro-components';
...
const UpdateProduct = () => {
    ...
    const handleFinish = async (values: any): Promise<boolean> => {
        ...
        try {
            ...
            navigate(-1);
            return true; // Return true if the form submission was successful.
        } catch (error) {
            setLoading(false);
            handleErrorResponse(error);
            return false; // Return false if there was an error during submission.
        }
    };
